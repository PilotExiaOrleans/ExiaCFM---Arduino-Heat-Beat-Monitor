int Simulation(int m,int repere,int repere_const)        //Dans cette fonction, nous simulons des valeurs basses et hautes à intervalle régulier correspondant à la durée d'un battement et l'écart entre deux battements.
